...
public class worldTab extends Fragment {
    ...
    private static final String TAG = "WorldTabFragment";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Log.d(TAG, "onCreateView: world started.");
        // Inflate the layout for this fragment
        root = inflater.inflate(R.layout.fragment_world_tab, container, false);
    ...
    private void initData() {
        ...
        String url = "https://pranav-newsapp-backend.appspot.com/app/world";
