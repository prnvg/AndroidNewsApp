 ...
 */
public class politicsTab extends Fragment {

    private static final String TAG = "PoliticsTabFragment";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Log.d(TAG, "onCreateView: politics started.");
        // Inflate the layout for this fragment
        root = inflater.inflate(R.layout.fragment_politics_tab, container, false);
    ...
    private void initData() {
        ...
        String url = "https://pranav-newsapp-backend.appspot.com/app/politics";
