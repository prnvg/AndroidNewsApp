...
public class technologyTab extends Fragment {
    ...
    private static final String TAG = "TechnologyTabFragment";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Log.d(TAG, "onCreateView: tech started.");
        // Inflate the layout for this fragment
        root = inflater.inflate(R.layout.fragment_technology_tab, container, false);
    ...
    private void initData() {
        ...
        String url = "https://pranav-newsapp-backend.appspot.com/app/technology";
