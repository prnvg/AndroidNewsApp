...
public class scienceTab extends Fragment {
    ...
    private static final String TAG = "ScienceTabFragment";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Log.d(TAG, "onCreateView: science started.");
        // Inflate the layout for this fragment
        root = inflater.inflate(R.layout.fragment_science_tab, container, false);
    ...
    private void initData() {
        ...
        String url = "https://pranav-newsapp-backend.appspot.com/app/science";
