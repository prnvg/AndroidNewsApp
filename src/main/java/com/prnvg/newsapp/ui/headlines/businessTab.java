...
public class businessTab extends Fragment {
    ...
    private static final String TAG = "BusinessTabFragment";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Log.d(TAG, "onCreateView: business started.");
        // Inflate the layout for this fragment
        root = inflater.inflate(R.layout.fragment_business_tab, container, false);
    ...
    private void initData() {
        ...
        String url = "https://pranav-newsapp-backend.appspot.com/app/business";
